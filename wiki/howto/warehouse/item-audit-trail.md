...
type: howto
tags: [inventory, audit, compliance, traceability]
created: 2026-04-21
updated: 2026-04-21
sources: [item-audit-trail-guide.md]
---

# Item Audit Trail

The Item Audit Trail system provides comprehensive tracking of all changes made to items in the system. Every modification is logged with details about what changed, who changed it, when, and which production order or document triggered the change.
...
3. Click **Apply Filter** (or **Search**).
...
### Audit report takes too long to generate
