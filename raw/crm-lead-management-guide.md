...
The CRM Lead Management system helps track potential customers from initial contact through conversion to active Business Central customers. This guide covers lead creation, qualification, activity tracking, and customer conversion.
...
### Contact Management
- Leads are stored as Contacts (Type = Company)
- Follows standard Business Central contact structure
- Can use standard contact features (duplicates, merge, etc.)

### Customer Creation
- Uses standard "Create Customer from Contact" process
- Marketing Setup determines business relation codes
- Customer dimensions added automatically

### Opportunities
- Standard Business Central opportunity management
- Integrated with sales cycles and campaigns
- Reporting available through standard opportunity reports

---

## Tips for Success

💡 **Log everything** - Create activities for all significant interactions  
💡 **Schedule follow-ups** - Use To Do activities to stay organized  
💡 **Update status promptly** - Keep lead status current  
💡 **Complete data entry** - Red warnings hurt your data quality metrics  
💡 **Review regularly** - Check role center tiles daily for overdue items  
💡 **Use opportunities** - Track potential sales alongside activities  
💡 **Team communication** - Add notes visible to other team members  
...
### Common Actions
- **New Lead** - Search "My Leads" → New → Create Lead
- **New Activity** - Lead Card → CRM → [Activity Type]
- **View Activities** - Lead Card → Navigate → CRM Entries
- **Request Application** - Lead Card → Process → Request Customer Application
- **Change Status** - Lead Card → Process → Change Status

### Status Quick Reference
- **Lead** - Starting status, active prospecting
- **Cust. Application** - Submitted for approval
- **Converted** - Customer created successfully
- **Not Qualified** - Lead not viable
...
**For training:** Request session with Sales Manager or System Administrator
