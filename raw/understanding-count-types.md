# Understanding Count Types - Staff Guide

## Why Different Count Types?

The system creates different types of counts for different business reasons. Understanding why you're counting helps you prioritize and recognize patterns.
...
**What it is:**
Items that will ship to customers within the next 2 weeks.
...
**What it is:**
Items on production orders that are finishing production soon (50% or more complete).
...
**What it is:**
Items on production orders immediately after sowing/planting.
...
**What it is:**
Items on production orders immediately after transplanting.
...
**What it is:**
Items showing negative inventory or negative available quantity in system.
...
**Special note:** Zero is likely correct answer - negative means we "owe" inventory that doesn't exist
...
**What it is:**
Items with unusually high sales activity recently.
...
**What it is:**
Complete, comprehensive count of all inventory (typically quarterly or yearly).
...
**What it is:**
Count of all items in a specific warehouse location/zone.
...
**What it is:**
Count of one specific item across all locations, or specific item in specific location.
...
- Check this guide
- Ask your supervisor
- Look at count history (what happened before)
...
*For technical details on count type configuration and automation, see Manager's Guides.*
